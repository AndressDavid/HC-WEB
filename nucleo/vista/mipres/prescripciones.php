<div class="container-fluid">
	<div class="card mt-3">
		<div class="card-header">
			...
			<small>
			<h5><span class="fas fa-prescription" style="color: #17A2B8;"> </span> Consulta Prescripciones</h5>
...
<script type="text/javascript" src="vista-mipres/js/prescripcion.js"></script>
