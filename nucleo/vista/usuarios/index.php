<?php
	...
	if(isset($_GET)){
		if(isset($_GET['p'])){
			...
			switch ($lcPagina) {
				case "listausuarios":
					$lcPagina="listaUsuarios";
					break;
					
				case "registrosusuario":
					$lcPagina="registrosUsuario";
					break;					
			}
	...
	if($llPagina==false){
		...
		$laOpcionesMenu[] = [
			'url' => 'modulo-usuarios&p=listaUsuarios',
			'icono' => 'book-medical',
			'titulo' => 'Usuarios de la aplicaci&oacute;n',
			'texto' => 'Muestra la lista de usuarios de la aplicaci&oacute;n',
		];
