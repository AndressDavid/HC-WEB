...
function reloadBitacora(){
	formPostTemp('modulo-bitacoras&p=registroBitacoras&q=<?php print($loBitacoras->getTipoBitacora()['CODIGO']); ?>', {CONSECUTIVO: goConsecutivo, INGRESO: <?php print($loBitacoras->getIngreso()->nIngreso); ?>}, false);	
}
...
$(function() {
	...
	goValidatorCabecera = $( "#cabeceraForm" ).validate( {
		...
		submitHandler: function () {
			...
			$.ajax({
				type: 'POST',
				url: "vista-bitacoras/ajax/registroBitacoras.ajax?cabecera&p=<?php print($loBitacoras->getConsecutivo()); ?>&q=<?php print($loBitacoras->getTipoBitacora()['CODIGO']); ?>&r=<?php print($loBitacoras->getIngreso()->nIngreso); ?>",
	...
	goValidatorSeguimiento = $( "#seguimientoForm" ).validate( {
		...
		submitHandler: function () {
			...
			$.ajax({
				type: 'POST',
				url: "vista-bitacoras/ajax/registroBitacoras.ajax?p=<?php print($loBitacoras->getConsecutivo()); ?>&q=<?php print($loBitacoras->getTipoBitacora()['CODIGO']); ?>&r=<?php print($loBitacoras->getIngreso()->nIngreso); ?>",
	...
	goValidatorProveedor = $( "#proveedorForm" ).validate( {
		...
		submitHandler: function () {
			...
			$.ajax({
				type: 'POST',
				url: "vista-bitacoras/ajax/registroBitacoras.ajax?proveedor&p=<?php print($loBitacoras->getConsecutivo()); ?>&q=<?php print($loBitacoras->getTipoBitacora()['CODIGO']); ?>&r=<?php print($loBitacoras->getIngreso()->nIngreso); ?>",
	...
	$('#cProveedorCodigo').on("change", function() {
		$.ajax({
			type: 'POST',
			url: "vista-bitacoras/ajax/registroBitacoras.ajax?proveedorEspecifico&p=<?php print($loBitacoras->getConsecutivo()); ?>&q=<?php print($loBitacoras->getTipoBitacora()['CODIGO']); ?>&r=<?php print($loBitacoras->getIngreso()->nIngreso); ?>",
