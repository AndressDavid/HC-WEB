...
class BorderBuilder
{
     ...
     */
    public function setBorderAll($color = Color::BLACK, $width = Border::WIDTH_MEDIUM, $style = Border::STYLE_SOLID)
    {
        $this->border
			->addPart(new BorderPart(Border::TOP, $color, $width, $style))
			->addPart(new BorderPart(Border::RIGHT, $color, $width, $style))
			->addPart(new BorderPart(Border::BOTTOM, $color, $width, $style))
			->addPart(new BorderPart(Border::LEFT, $color, $width, $style));
